    ...
    <footer className="bg-[#050505] border-t border-[#111] text-gray-400 text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 mt-4">
            <a 
              ...
              className="p-2 rounded-full bg-[#111] hover:bg-[#FF2D8D] hover:text-white text-gray-400 transition duration-300"
            >
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            <li>
              <button onClick={() => handleNav('home')} className="hover:text-[#FF2D8D] transition text-xs cursor-pointer">
                Início
              </button>
            </li>
            <li>
              <button onClick={() => handleNav('catalogo')} className="hover:text-[#FF2D8D] transition text-xs cursor-pointer">
                Estoque Completo
              </button>
            </li>
            <li>
              <button onClick={() => handleNav('financiamento')} className="hover:text-[#FF2D8D] transition text-xs cursor-pointer">
                Solicitar Financiamento
              </button>
            </li>
            <li>
              <button onClick={() => handleNav('avaliacao')} className="hover:text-[#FF2D8D] transition text-xs cursor-pointer">
                Avaliar meu Veículo
              </button>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-xs text-gray-400">
            <li className="flex items-start gap-2">
              <Clock className="w-4 h-4 text-[#FF2D8D] shrink-0 mt-0.5" />
              <div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-xs text-gray-400">
            ...
            <li className="flex items-center gap-2">
              <Phone className="w-4 h-4 text-[#FF2D8D] shrink-0" />
              <span className="text-gray-500">{settings.phone}</span>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="w-4 h-4 text-[#FF2D8D] shrink-0" />
      ...
      <div className="bg-[#020202] py-6 border-t border-[#111]">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600">
          ...
          <div className="flex items-center gap-1 text-[#FF2D8D]/60">
